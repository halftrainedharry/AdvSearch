...
$_lang['advsearch.advsearchform_searchParam_desc'] = 'The name of the REQUEST parameter that the search will use.';
...
$_lang['advsearch.advsearch_pageParam_desc'] = 'The name of the REQUEST parameter to use for the pagination page.';
...
$_lang['advsearch.advsearch_pagingTpl_desc'] = 'The chunk to use for the pagination';
$_lang['advsearch.advsearch_pagingSeparator_desc'] = 'String as page number links separator.';
...
$_lang['advsearch.advsearch_searchParam_desc'] = 'The name of the REQUEST parameter that the search will use.';
