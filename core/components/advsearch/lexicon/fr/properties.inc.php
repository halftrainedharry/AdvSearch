...
$_lang['advsearch.advsearchform_searchParam_desc'] = 'Le nom du paramètre de la requête utilisé pour le terme de recherche.';
...
$_lang['advsearch.advsearch_pageParam_desc'] = 'Nom du paramètre HTTP REQUEST à utiliser pour la page de pagination.';
...
$_lang['advsearch.advsearch_paging1Tpl_desc'] = 'Le chunk a utiliser pour la pagination.';
$_lang['advsearch.advsearch_pagingSeparator_desc'] = 'Chaine de caractères utilisée comme séparateur dans la liste de pages. Utilisé par le type de pagination 2 et 3.';
...
$_lang['advsearch.advsearch_searchParam_desc'] = 'Nom du paramètre HTTP REQUEST à utiliser pour la soumission de la recherche.';
